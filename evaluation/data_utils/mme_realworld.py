...
@dataclass
class MMERealWorldSample(BaseDatasetSample):
    data_dir: str = ""

    def __post_init__(self):
        self.image = self.row["bytes"]
        options = self.row["multi-choice options"]
...
class MMERealWorldEvaluator(BaseDatasetEvaluator):
    sample_cls = MMERealWorldSample

    def get_desc(self):
        return "Evaluating MME-RealWorld"
