...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    if "bbox_count" in batch.non_tensor_batch:
        bbox_count = batch.non_tensor_batch["bbox_count"]
        metrics["bbox_count/min"] = bbox_count.min()
        metrics["bbox_count/max"] = bbox_count.max()
        metrics["bbox_count/mean"] = bbox_count.mean()
